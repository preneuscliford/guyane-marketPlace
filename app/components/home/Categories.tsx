  ...
  const categories = [
    {
      ...
      count: 78,
      color: "bg-indigo-600",
      href: "/marketplace/categories/artisanat",
    },
    {
    ...
    },
    {
      ...
      href: "/marketplace/categories/agriculture",
    },
    {
      ...
      count: 67,
      color: "bg-amber-600",
      href: "/marketplace/categories/tourisme",
    },
    {
      ...
      count: 234,
      color: "bg-purple-600",
      href: "/marketplace/categories/produits",
    },
    {
      ...
      count: 89,
      color: "bg-red-600",
      href: "/marketplace/categories/restauration",
    },
    {
      ...
      count: 46,
      color: "bg-teal-600",
      href: "/marketplace/categories/evenements",
    },
    {
      ...
      count: 54,
      color: "bg-pink-600",
      href: "/marketplace/categories/bien-etre",
    },
  ];
