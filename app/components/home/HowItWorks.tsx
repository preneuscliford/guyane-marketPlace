...
const Step: React.FC<StepProps & { number: number; index: number }> = ({
  title,
  description,
  icon,
  number,
  ...
  const steps: StepProps[] = [
    {
      ...
      description:
        "Créez votre compte en moins de 2 minutes. Il vous suffit d'une adresse email valide pour commencer votre expérience sur mcGuyane.",
      icon: <UserPlus className="h-10 w-10" />,
    },
    {
      title: "Publication rapide",
      description:
        "Déposez votre annonce en quelques clics. Ajoutez une description détaillée, des photos et fixez votre prix selon vos conditions.",
      icon: <Send className="h-10 w-10" />,
    },
    {
      title: "Communication directe",
      description:
        "Échangez avec les autres utilisateurs via notre messagerie sécurisée intégrée. Organisez vos rendez-vous en toute simplicité.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Trois étapes simples pour rejoindre notre communauté et commencer à
            échanger
          </p>
          <motion.div
